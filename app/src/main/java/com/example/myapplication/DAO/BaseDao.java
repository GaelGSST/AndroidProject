...
import com.example.myapplication.model.entities.BaseEntity;
...
public abstract class BaseDao<T extends BaseEntity> {
    ...
    public List<T> lastThreeBestScores(){
        SQLiteDatabase db = dbHelper.getReadableDatabase();

        Cursor cursor = db.rawQuery("SELECT * FROM Scores ORDER BY Score DESC LIMIT 3", null);
